...
AGENT_DEFINITIONS = {
    ...
    "pdf-agent": {
        ...
        "description": "Produces short, research-paper-style PDF reports for download; uses research context and can add graphs via sandbox.",
        "tools": ["web_search", "fetch_url", "modal_sandbox", "create_report_pdf"],
    },
}
...
- pdf-agent: produces short, downloadable PDF reports (research-paper style, with optional graphs). Assign when the user wants a report, summary PDF, research brief, or downloadable document.
...
- PDF report: {"agents": {"paper-collector": ["find key papers and resources on the topic"]}, "pdf-agent": ["Produce a short PDF report from the research context; add a figure if helpful"]}
